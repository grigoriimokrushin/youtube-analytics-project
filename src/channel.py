...
class Channel:
    ...
    def __init__(self, channel_id: str):
        ...
        self.view_count = channel_info_dict['items'][0]['statistics']['viewCount']
        self.subscriber_count = channel_info_dict['items'][0]['statistics']['subscriberCount']
        self.video_count = channel_info_dict['items'][0]['statistics']['videoCount']
